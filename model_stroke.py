...
model = load_model("data/stroke_risk_model.keras")
scaler = joblib.load("data/stroke_scaler.pkl")
...
st.write("Answer the questions below to estimate your risk of having stroke.")
...
if st.button("Calculate Risk"):
    ...
    try:
        ...
        st.write(f"Your predicted risk of stroke is **{risk_score:.2%}**")
