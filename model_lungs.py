...
model = load_model("data/lung_risk_model.keras")
scaler = joblib.load("data/lung_scaler.pkl")
...
st.title("🫁 Lung Risk Predictor")
st.write("Answer the questions below to estimate your risk of having lung disease.")
...
if st.button("Calculate Risk"):
    ...
    try:
        ...
        st.write(f"Your predicted risk of lung disease is **{risk_score:.2%}**")
