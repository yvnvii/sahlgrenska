...
model = load_model("data/thyroid_risk_model.keras")
scaler = joblib.load("data/thyroid_scaler.pkl")
...
st.title("🫁 Thyroid Risk Predictor")
st.write("Answer the questions below to estimate your risk of having thyroid.")
...
if st.button("Calculate Risk"):
    ...
    try:
        ...
        st.write(f"Your predicted risk of thyroid is **{risk_score:.2%}**")
