...
model = load_model("data/heart_failure_risk_model.keras")
scaler = joblib.load("data/heart_failure_scaler.pkl")
...
st.write("Answer the questions below to estimate your risk of having a heart failure.")
...
if st.button("Calculate Risk"):
    ...
    try:
        ...
        st.write(f"Your predicted risk of heart failure is **{risk_score:.2%}**")
